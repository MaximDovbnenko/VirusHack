...
class Response:
    ...
    def Recognize(self):
        ...
        self.Context = self.Context.replace("PROGRESS_2", "background-color:blue ; width: " + str(self.process_1) + "%")
        self.Context = self.Context.replace("PROGRESS_3", "background-color:green ; width: " + str(self.process_1) + "%")
        self.Context = self.Context.replace("PROGRESS_4", "background-color:fuchsia ; width: " + str(self.process_1) + "%")
        self.Context = self.Context.replace("PROGRESS_5", "background-color:black ; width: " + str(self.process_1) + "%")
